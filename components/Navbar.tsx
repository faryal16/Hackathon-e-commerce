...
export default function Navbar() {
  return (
    <nav className="wrapper  relative  mb-12 h-[40px] bg-white text-[#0D0E43] p-6">
      <div className=" px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center  text-[14px]  space-x-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-[#f175ab] text-white rounded-2xl shadow-lg">
                <DropdownMenuItem>
                  <Link href="/shop_left_sidebar">Shop Left Sidebar</Link>
                </DropdownMenuItem>
                <DropdownMenuItem>
              ...
              <Sheet>
                ...
                <SheetContent className="items-center bg-gray-800 text-white justify-center flex flex-col gap-10">
                  ...
                  <div className="flex flex-col justify-center items-start space-y-6 text-[14px]  ">
                    ...
                    >
                      <DropdownMenu>
                        <DropdownMenuTrigger className="flex justify-center items-end gap-1 hover:text-[#FB2E86] ">
                          Products
                          <IoIosArrowDown size={12} />
                        </DropdownMenuTrigger>
                        <DropdownMenuContent className="bg-[#f175ab] text-white rounded-2xl shadow-lg">
